...
urlpatterns = patterns('djang0byte.main.views',
  ('^user/(.*)/$', 'profile'),
  ('^newblog/$', 'newblog'),
  url('^newpost/$', 'new_post', name='main_new_post'),
  url('^newanswer/$', 'new_answer', name='main_new_answer'),
  ...
  url('^action/edit_post/(?P<post_id>\d*)/$', 'edit_post', name='main_edit_post'),
  ...
  ('^myblogs/$', 'myblogs'),
  ('^myblogs/(.*)/$', 'myblogs'),
  url('^draft/(?P<draft_id>\d*)/$', 'edit_draft', name='main_edit_draft'),
  url('^public_draft/(?P<draft_id>\d*)/$', 'public_draft', name='main_public_draft'),
  url('^new_draft/', 'edit_draft', name='main_new_draft'),
  url('^draft/', 'draft', name='main_drafts'),
  ('^page/(.*)/$', 'text_page'),
  ('^search/$', 'search'),
